...
def FeatureCard(icon: str, title: str, description: str):
    ...
    st.markdown(
        f"""
        <div style="background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 0.875rem 1rem; 
            ...
            <div style="flex: 1;">
                ...
                <p style="margin: 0; color: #666; font-size: 1rem; line-height: 1.5;">{description}</p>
            </div>
        </div>
        """,
